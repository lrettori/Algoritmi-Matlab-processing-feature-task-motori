 function [vel10,vel10SD,exc10,exc10SD,dec10B,dec10M,dec10E,hes10,int10,frz10,...
          ...
          fHmotor2(directory,filename,hand_N,trial,data2_ax,data2_ay,data2_az,...
             data2_wx,data2_wy,data2_wz,ts,fs_daphne,exercise)


%% Rimozione offset dal segnale giroscopio
data2_wx = data2_wx - mean(data2_wx(100:200));
data2_wy = data2_wy - mean(data2_wy(100:200));
data2_wz = data2_wz - mean(data2_wz(100:200));
