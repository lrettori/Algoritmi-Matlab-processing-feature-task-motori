...
filenameData = 'D:\Ricerca UNIFI\Olimpia\Dati\Dati per prove debug\FRST_Ex1 - Copia.txt';
% filenameData = 'D:\Ricerca UNIFI\Olimpia\Dati\Dati per prove debug\FRST_Ex2 - Copia.txt'; % 1_A_D_06101949C60SSSA2
firstImportRawData = importdata(filenameData);
% Estraggo le sole colonne di mio interesse
data_ax = firstImportRawData.data(:,37);
data_ay = firstImportRawData.data(:,38);
data_az = firstImportRawData.data(:,39);
data_wx = firstImportRawData.data(:,40);
data_wy = firstImportRawData.data(:,41);
data_wz = firstImportRawData.data(:,42);

% Setto altri parametri di inizializzazione (DA CONTROLLARE)
directory = 'D:\Ricerca UNIFI\Olimpia\Dati\Dati per prove debug';
filename = 'FRST_Ex1 - Copia';
